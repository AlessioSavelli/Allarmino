...
#define PRG_JUMPER 16 //Corrisponde a RX2
...
//Modilità Wifi o Ethernet
#define INTERNET_WiFi 0x01
#define INTERNET_Eth  0x02

//Tipo di chipset usato per il modulo ethernet
#define EHT_CHIPSET_W5500     0x01
#define EHT_CHIPSET_ENC28J60  0x02


#define INTERNET_MODE         INTERNET_Eth
#define ETHERNET_CHIPSET      EHT_CHIPSET_ENC28J60
//---Configurazione Ethernet---

/*
    per usare al meglio il modulo ethernet e far si che il sistema funzioni occore usare il chip W5200 o il W5500 altrimenti non funziona lo stato del WiFi
*/
#define ETH_MAC      0x38, 0xFD, 0x23, 0x82, 0x9E, 0x41
#define ETH_SPI_PORT CS1_SPI

//---Configurazione WiFi-----
#define WiFi_SSID "Internet"
#define WiFi_PASS "P@ass+4"
//La modalità del wifi è fissa su internet_stA


#define INTERNET_CONNECTION_TRIES_DELAY 5000 //5000ms tra una prova e l'altra
#define INTERNET_CONNECTION_ERROR_AFTER_TRIES 2 // dopo 2 volte che prova a connettersi triggera il flag di errore wifi. tentativi massimi 255
//--------
//--------
...
//#define TELEGRAM_GROUP_NAME   "GroupName"
#define TELEGRAM_GROUP_ID     -999999
//
#define TELEGRAM_PASSWORD_INSTALLATORE "Admin@123" // è consigliato usare almeno 8 caratteri numerici e alfanumerici es. 'Admin@123'
#define TELEGRAM_INSTALLATORE_IDLE    5 * 60 * SECONDS // trascorso questo tempo di inattività disattiverà la sessione di installatore, minimo consigliato un minuto massimo 5 minuti
